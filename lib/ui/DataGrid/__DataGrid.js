...
alert(nextProps.scrollTop);
			this.setState({offset: nextProps.scrollTop});
		}
	};
...
/*
class DataGrid extends React.Componnent {
...
//
	render() {
		return (
			<div className='px-datagrid'>
				<div className='px-datagrid-scrollbox' onScroll={this._scrollEvent.bind(this)}>
					<DataGridContainer {...this.props} scrollTop={this.state.scrollTop} />
				</div>
			</div>
		);
	};
